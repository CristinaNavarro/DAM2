...
public class Desencriptado {
    public static void main(String[] args) {
        try {
            ...
            File inf = new File("C:\\Users\\Cristi\\pruebaEncriptacion\\pruebaJDes.txt");
            FileInputStream is = new FileInputStream(inf);
            FileOutputStream os = new FileOutputStream("C:\\Users\\Cristi\\pruebaEncriptacion\\fichero_descifradodelodejose_DES.txt");
