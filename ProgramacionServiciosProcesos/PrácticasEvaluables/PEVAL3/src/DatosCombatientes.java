...
*/
class DatosCombatientes {
    private String[] listadoEstadisticas = {"Salud", "Ataque", "Resistencia", "Curación"};
    private String[] listadoTipos = {"Guerrero", "Chaman", "Cazador", "Sacerdote"};
    private int[] datosGuerrero = {900, 400, 200, 0};
    private int[] datosChaman = {1000, 500, 0, 100};
    private int[] datosCazador = {800, 600, 100, 0};
    private int[] datosSacerdote = {1100, 300, 0, 200};

    String[] getListadoEstadisticas() {
        return this.listadoEstadisticas;
    }

    String[] getListadoTipos() {
        return this.listadoTipos;
    }

    int[] getDatosGuerrero() {
        return this.datosGuerrero;
    }

    int[] getDatosChaman() {
        return this.datosChaman;
    }

    int[] getDatosCazador() {
        return this.datosCazador;
    }

    int[] getDatosSacerdote() {
        return datosSacerdote;
    }
}
